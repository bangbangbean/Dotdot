...
public class aaa extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnInfoWindowClickListener {
...
/** this code is used to get the permission/ check the permission allow or not*/
    ...
    public void onInfoWindowClick(Marker marker) {
        ...
        Intent intent = new Intent(aaa.this, botnav.class);
